    ...
    return (
        <div>
            ...
            <div className="container">
                {/* <Date date="日付" lodgingUrl="宿のURL" lodgingName="宿の名前" spots="観光スポット" /> */}
                ...
                <Date schedules={schedules.day24} date="7/24" lodgingUrl="宿のURL" lodgingName="宿の名前" spots="観光スポット" />
                <Date schedules={schedules.day25} date="7/25" lodgingUrl="宿のURL" lodgingName="宿の名前" spots="観光スポット" />
                <Date schedules={schedules.day26} date="7/26" lodgingUrl="宿のURL" lodgingName="宿の名前" spots="観光スポット" />
                <Date schedules={schedules.day27} date="7/27" lodgingUrl="宿のURL" lodgingName="宿の名前" spots="観光スポット" />
                <Date schedules={schedules.day28} date="7/28" lodgingUrl="宿のURL" lodgingName="宿の名前" spots="観光スポット" />
                <Date schedules={schedules.day29} date="7/29" lodgingUrl="宿のURL" lodgingName="宿の名前" spots="観光スポット" />
            </div>
        </div>
    )
}